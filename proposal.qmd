...
When grouped by age, nearly half (49%) of the responses were from people who were aged 25 to 34 years old. 24% were aged 35 to 44 years old. The distribution of ages is skewed to the left with very few (0.5%) under 18 years old. 
```{r}
coffee_survey |>
  group_by(age) |>
  summarize(Freq = n()) 
